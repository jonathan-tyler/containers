...
- `squid/Containerfile`: multi-stage squid image build for distroless runtime.
...
- Proxy image: `registry.access.redhat.com/hi/core-runtime:latest` copied from a `latest-builder` installroot stage
