...
feature +features: prepare
    {{feature_ci_env}} devcontainer features test --project-folder "{{feature_project_root}}" --skip-autogenerated --skip-duplicated --base-image "{{workflow_base_image}}" --remote-user "{{workflow_remote_user}}" -f {{features}}
